...
public open class PhysicsPointQueryParameters2D : RefCounted() {
  ...
  public final fun setCanvasInstanceId(canvasInstanceId: Long): Unit {
    TransferContext.callPtrMethod_LONG(ptr, objectID.id, MethodBindings.setCanvasInstanceIdPtr, canvasInstanceId)
  }

  public final fun getCanvasInstanceId(): Long =
      TransferContext.callPtrMethod0_ret_LONG(ptr, objectID.id, MethodBindings.getCanvasInstanceIdPtr)
