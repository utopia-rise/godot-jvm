...
public open class NavigationLink3D : Node3D() {
  ...
  public final fun setStartPosition(position: Vector3): Unit {
    TransferContext.callPtrMethod_VECTOR3(ptr, objectID.id, MethodBindings.setStartPositionPtr, position)
  }

  public final fun getStartPosition(): Vector3 =
      TransferContext.callPtrMethod0_ret_VECTOR3(ptr, objectID.id, MethodBindings.getStartPositionPtr)

  public final fun setEndPosition(position: Vector3): Unit {
    TransferContext.callPtrMethod_VECTOR3(ptr, objectID.id, MethodBindings.setEndPositionPtr, position)
  }

  public final fun getEndPosition(): Vector3 =
      TransferContext.callPtrMethod0_ret_VECTOR3(ptr, objectID.id, MethodBindings.getEndPositionPtr)
  ...
  public final fun setGlobalStartPosition(position: Vector3): Unit {
    TransferContext.callPtrMethod_VECTOR3(ptr, objectID.id, MethodBindings.setGlobalStartPositionPtr, position)
  }
  ...
  public final fun getGlobalStartPosition(): Vector3 =
      TransferContext.callPtrMethod0_ret_VECTOR3(ptr, objectID.id, MethodBindings.getGlobalStartPositionPtr)
  ...
  public final fun setGlobalEndPosition(position: Vector3): Unit {
    TransferContext.callPtrMethod_VECTOR3(ptr, objectID.id, MethodBindings.setGlobalEndPositionPtr, position)
  }
  ...
  public final fun getGlobalEndPosition(): Vector3 =
      TransferContext.callPtrMethod0_ret_VECTOR3(ptr, objectID.id, MethodBindings.getGlobalEndPositionPtr)
