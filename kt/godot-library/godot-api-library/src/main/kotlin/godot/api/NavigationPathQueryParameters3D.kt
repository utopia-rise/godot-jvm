...
public open class NavigationPathQueryParameters3D : RefCounted() {
  ...
  public final fun setStartPosition(startPosition: Vector3): Unit {
    TransferContext.callPtrMethod_VECTOR3(ptr, objectID.id, MethodBindings.setStartPositionPtr, startPosition)
  }
  ...
  public final fun setTargetPosition(targetPosition: Vector3): Unit {
    TransferContext.callPtrMethod_VECTOR3(ptr, objectID.id, MethodBindings.setTargetPositionPtr, targetPosition)
  }
