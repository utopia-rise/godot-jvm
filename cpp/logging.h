...
#define JVM_ERR_FAIL_V_MSG(ret_var, message, ...) ERR_FAIL_V_EDMSG(ret_var, JVM_STRING_FORMAT(message, ##__VA_ARGS__))
...
#define JVM_ERR_FAIL_V_MSG(ret_var, message, ...) ERR_FAIL_V_MSG(ret_var, JVM_STRING_FORMAT(message, ##__VA_ARGS__))
#define JVM_ERR_FAIL_COND_MSG(condition, message, ...) \
