...
namespace godot {
    ...
    private:
        ...
        static GDExtensionBool get_class_category(
            GDExtensionScriptInstanceDataPtr p_instance,
        ...
        static GDExtensionBool validate_property(
            GDExtensionScriptInstanceDataPtr p_instance,
        ...
        static GDExtensionBool set_fallback(
            GDExtensionScriptInstanceDataPtr p_instance,
            GDExtensionConstStringNamePtr p_name,
            GDExtensionConstVariantPtr p_value
        );
        static GDExtensionBool get_fallback(
            GDExtensionScriptInstanceDataPtr p_instance,
            GDExtensionConstStringNamePtr p_name,
            GDExtensionVariantPtr r_ret
        );
    ...
    public:
        ...
        static void update(
            JvmPlaceHolderInstanceData* p_instance_data,
