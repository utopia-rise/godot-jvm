...
jfloatArray PackedVector4ArrayBridge::engine_convert_to_jvm(JNIEnv* p_raw_env, jobject, jlong p_handle) {
    jni::Env env(p_raw_env);
    godot::PackedVector4Array& vector_packed = native<godot::PackedVector4Array>(p_handle);
