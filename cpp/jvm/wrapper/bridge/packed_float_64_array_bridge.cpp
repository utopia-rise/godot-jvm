...
jdoubleArray PackedFloat64ArrayBridge::engine_convert_to_jvm(JNIEnv* p_raw_env, jobject, jlong p_handle) {
    godot::PackedFloat64Array& packed = native<godot::PackedFloat64Array>(p_handle);
