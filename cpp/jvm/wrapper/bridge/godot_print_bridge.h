...
namespace bridges {
    ...
    public:
        ...
        static void print_verbose2(
            JNIEnv * p_raw_env,
            jobject,
            jstring p_string
        ); // Can't be named normally this because a godot macro of the same name is already included.
        ...
        // TODO: Use this method to get the JVM stacktrace when Godot will add the features to script
