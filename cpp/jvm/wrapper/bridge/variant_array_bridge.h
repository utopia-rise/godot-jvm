...
namespace bridges {
    ...
    public:
        ...
        static void engine_call_shuffle(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_sort(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_sortCustom(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        ...
        static void engine_call_bsearchCustom(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        ...
        static void engine_call_duplicate_deep(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_erase(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_find(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_front(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        ...
        static void engine_call_max(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_min(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_popBack(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_popFront(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_pushBack(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_pushFront(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        ...
        static void engine_call_operator_set(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_operator_get(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_all(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_any(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_appendArray(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_back(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_fill(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_filter(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_getTypedClassName(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_getTypedScript(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_isReadOnly(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_isTyped(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_map(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_pickRandom(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
        static void engine_call_reduce(JNIEnv * p_raw_env, jobject p_instance, jlong p_handle);
    };
