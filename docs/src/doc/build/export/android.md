...
To override SDK discovery or the minimum API level, use `android.d8ToolPath`, `android.compileSdkDirectory`, and `android.minApiLevel`. [Android, GraalVM and iOS inputs](../../reference/gradle-plugin/export-targets.md) lists their defaults and examples.
