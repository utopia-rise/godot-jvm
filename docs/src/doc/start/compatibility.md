...
Minimum Kotlin version: **2.3.20**. Default Kotlin plugin version: **2.3.20**. Lower versions are rejected. See [`toolchain.kotlinVersion`](../reference/gradle-plugin/languages-and-toolchains.md#toolchainkotlinversion) for override rules.

///

/// tab | Java

Minimum Java toolchain: **17**. Default: **17**. See [`toolchain.javaVersion`](../reference/gradle-plugin/languages-and-toolchains.md#toolchainjavaversion) for configuration.

///

/// tab | Scala

Minimum Scala version: **3.0.0**. Default Scala runtime/compiler version: **3.6.3**. Lower major versions are rejected. See [`toolchain.scalaVersion`](../reference/gradle-plugin/languages-and-toolchains.md#toolchainscalaversion) for configuration.
