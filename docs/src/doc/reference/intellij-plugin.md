...
Controls registration inspections and highlighting. It does not change Gradle's registration mode. Match [`registration.annotationProcessingMode`](gradle-plugin/registration.md#registrationannotationprocessingmode) to keep IDE feedback consistent with the build.
