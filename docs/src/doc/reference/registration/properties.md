...
`@Category`, `@Group`, and `@Subgroup` insert section markers before a property while preserving its type hint. See [Inspector groups](../annotations.md#inspector-groups) for arguments and prefix matching.
